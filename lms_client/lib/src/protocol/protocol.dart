...
import 'enum/question_status.enum.dart' as _i4;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.QuestionStatus) {
      return _i4.QuestionStatus.fromJson(data) as T;
    }
    if (t == _i5.Roles) {
    ...
    if (t == _i1.getType<_i4.QuestionStatus?>()) {
      return (data != null ? _i4.QuestionStatus.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'QuestionStatus') {
      return deserialize<_i4.QuestionStatus>(data['data']);
    }
