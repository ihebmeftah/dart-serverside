...
import 'quiz.dart' as _i9;
import 'protocol.dart' as _i10;
import 'package:lms_client/src/protocol/category.dart' as _i11;
import 'package:lms_client/src/protocol/quiz.dart' as _i12;
import 'package:lms_client/src/protocol/player.dart' as _i13;
import 'package:lms_client/src/protocol/admin.dart' as _i14;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i9.Quiz) {
      return _i9.Quiz.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i9.Quiz?>()) {
      return (data != null ? _i9.Quiz.fromJson(data, this) : null) as T;
    }
    ...
    if (t == _i1.getType<List<_i10.Quiz>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i10.Quiz>(e)).toList()
          : null) as dynamic;
    }
    ...
    if (t == List<_i12.Quiz>) {
      return (data as List).map((e) => deserialize<_i12.Quiz>(e)).toList()
          as dynamic;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'Quiz') {
      return deserialize<_i9.Quiz>(data['data']);
    }
