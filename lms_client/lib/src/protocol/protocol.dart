...
import 'option.dart' as _i7;
import 'player.dart' as _i8;
import 'question.dart' as _i9;
import 'quiz.dart' as _i10;
import 'protocol.dart' as _i11;
import 'package:lms_client/src/protocol/category.dart' as _i12;
import 'package:lms_client/src/protocol/quiz.dart' as _i13;
import 'package:lms_client/src/protocol/player.dart' as _i14;
import 'package:lms_client/src/protocol/admin.dart' as _i15;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i7.Option) {
      return _i7.Option.fromJson(data, this) as T;
    }
    if (t == _i8.Player) {
      return _i8.Player.fromJson(data, this) as T;
    }
    if (t == _i9.Question) {
      return _i9.Question.fromJson(data, this) as T;
    }
    if (t == _i10.Quiz) {
      return _i10.Quiz.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i7.Option?>()) {
      return (data != null ? _i7.Option.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i8.Player?>()) {
      return (data != null ? _i8.Player.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i9.Question?>()) {
      return (data != null ? _i9.Question.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i10.Quiz?>()) {
      return (data != null ? _i10.Quiz.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<List<_i11.Category>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i11.Category>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i11.Quiz>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i11.Quiz>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i11.Option>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i11.Option>(e)).toList()
          : null) as dynamic;
    }
    if (t == _i1.getType<List<_i11.Question>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i11.Question>(e)).toList()
          : null) as dynamic;
    }
    ...
    if (t == List<_i13.Quiz>) {
      return (data as List).map((e) => deserialize<_i13.Quiz>(e)).toList()
          as dynamic;
    }
    ...
    if (t == List<_i15.Admin>) {
      return (data as List).map((e) => deserialize<_i15.Admin>(e)).toList()
          as dynamic;
    }
    if (t == List<int>) {
